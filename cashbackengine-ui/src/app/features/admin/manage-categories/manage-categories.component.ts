    ...
    <div class="table-card">
      <table mat-table [dataSource]="categories()">
        ...
        <ng-container matColumnDef="categoryUrl">
          ...
          <td mat-cell *matCellDef="let c"><code class="slug">{{ c.categoryUrl || '—' }}</code></td>
        </ng-container>
        ...
        <tr class="mat-row" *matNoDataRow>
          <td class="mat-cell empty-row" [attr.colspan]="cols.length">No categories yet. Add one above.</td>
        </tr>
      </table>
    </div>
  `,
...
export class ManageCategoriesComponent implements OnInit {
  ...
  cols = ['categoryId', 'name', 'categoryUrl', 'description', 'status', 'actions'];
  ...
  onEdit(c: Category): void {
    ...
    this.form.patchValue({ name: c.name, categoryUrl: c.categoryUrl ?? '', description: c.description ?? '', status: c.status });
    this.showForm.set(true);

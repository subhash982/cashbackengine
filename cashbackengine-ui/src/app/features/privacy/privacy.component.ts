...
@Component({
    ...
    <div class="page-wrap">
      <div class="content-wrap">
        ...
        <div class="content-box">
          ...
          <p>This document sets the legal ground and governs the manner in which <strong>'You' &amp; 'We'</strong> agree to use the
            data shared with each other. The data You share with us includes but is not limited to some of Your
          ...
          <h3 class="h3 secondary">Automatically Collected Information</h3>
          <p>Apart from personal information You provide, We may also collect some information about You using Cookies and monitoring Your click history.</p>

          <p><strong class="font-14">Use of Web Cookies:</strong> Cookies are used to carry some browsing data which is a technical necessity to operate the
            website. We do not place any personal or financial data in the Cookies. Usage of Cookies is solely on Your wish. You can enable or disable the Cookies any time in
            Your browser (which is enabled by default in most of the browsers). However, disabled Cookies will impact the operation of the website and You as a User will not be able to
          ...
          <p>Use of the information collected from the User either directly or indirectly is used to provide the
            service in the best possible manner and to improve the User experience only.</p>
          <p>Personal information we collect is used to identify You as a user and to make sure that we possess
            required information about the User (in case such information is sought after by Govt or Any Court
            within India or any law enforcement agency/department).</p>
          ...
          <p>Your information can also be used in avoiding and preventing any unlawful activity.</p>
          <p>As a trusted website We do not disclose any of the User's information to anyone with the following exceptions:</p>
          <ul class="ul margin-bottom30">
            <li>We may share some of your information (Name, email Id) with the merchant You make the purchase from. This is only for trouble shooting purposes.</li>
            <li>We will share the information if sought after by any Honourable Court of the relevant
              jurisdiction, Govt, Law enforcement agency or any entity referred by Honourable Court or Govt.</li>
          </ul>
          ...
          <p><strong>Note — For all matters with respect to this Privacy Policy You hereby agree to exclusive
            jurisdiction in the courts located in the state of Delhi, India.</strong></p>
  ...
  styles: [`
    ...
    :host ::ng-deep .font-14 { font-size: 14px; }
  `]
})

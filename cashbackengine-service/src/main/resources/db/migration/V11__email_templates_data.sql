...
(1, 'english', 'signup', 'Welcome to ₹upiya Bachao!',
'<table align="center" border="0" cellpadding="0" cellspacing="0" style="width:550px">
	<tbody>
		<tr><td><p><img src="http://rupiyabachao.in/images/hifi/logo.jpg" /></p></td></tr>
		<tr><td>
		<table border="0" cellpadding="0" cellspacing="0" style="width:100%">
			...
			<p><br />Thanks much,<br />₹upiya Bachao Team</p>
			</td></tr></tbody>
		</table>
		</td></tr>
		<tr><td>
		<table border="0" cellpadding="0" cellspacing="0" style="width:100%">
			...
			<p><a href="#">RSS Feed</a> Copyright &copy; 2016 rupiyabachao.in. All rights reserved.<br />
...
'<table border="0" cellpadding="0" cellspacing="0" style="width:550px; margin:auto; font-family:calibri; border:1px solid #f0f0f0;" align="center">
	<tbody>
		...
		<p><img src="http://rupiyabachao.in/images/hifi/logo.jpg" /></p>
		</td></tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" style="width:100%">
			...
			<p><a href="#" style="color:#0292ca; text-decoration:none;">RSS Feed</a> Copyright &copy; 2016 rupiyabachao.in. All rights reserved.<br />
...
'<table align="center" border="0" cellpadding="0" cellspacing="0" style="width:550px">
	<tbody>
		...
		<table border="0" cellpadding="0" cellspacing="0" style="width:100%">
			...
			<br /><strong>Best Regards,<br />₹upiya Bachao Team</strong>
			</td></tr></tbody>
		</table>
		</td></tr>
		<tr><td>
...
'<table align="center" border="0" cellpadding="0" cellspacing="0" style="width:550px">
	<tbody>
		<tr><td><a href="https://rupiyabachao.in/"><img src="http://rupiyabachao.in/images/hifi/logo.jpg" /></a></td></tr>
		<tr><td>
		<table border="0" cellpadding="0" cellspacing="0" style="width:100%">
			<tbody>
				<tr><td>
				<p>Hello <strong>{first_name},</strong></p>
				<p>Grab it before it is over! Avail latest RupiyaBachao offers from RupiyaBachao.</p>
				</td></tr>
				<tr><td>&nbsp;</td></tr>
				<tr><td>{offer_detail}</td></tr>
				<tr><td><p><br />Best Regards,<br />₹upiya Bachao Team</p></td></tr>
			</tbody>
		</table>
		</td></tr>
		<tr><td>
